...
void main() {
  ...
  group('T02 generator golden values', () {
    ...
    test('level 21 attempt 0 matches the generator v1 golden', () {
      final stage = _attemptStage(level: 21);
    ...
    test('level 201 remains unsupported', () {
